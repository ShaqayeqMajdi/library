    ...
    .map((book) => {
      return `
        <div class="products-card">
          <img src="./assets/images/books/${book.imgSrc}" alt="${book.title}" class="products-card__image" />
          ...
          <div class="products-card__overlay">
            <div class="products-card__details">
              ...
              <button class="products-card__buy-button">افزودن به کتابخانه <i class="fas fa-book-reader"></i></button>
            </div>
          </div>
        </div>
      `;
