            ...
            <div class="products-card__details">
             ...
             ${
               cartItems.includes(book.id)
                 ? `<a href="./carditem.html" class="products-card__buy-button">مشاهده کتابخانه<i class="fas fa-book-reader"></i></a>`
                 : `<button onclick=addToCart(${book.id}) class="products-card__buy-button">افزودن به کتابخانه<img src="./assets/images/icon/bookmark.svg" alt="bookmark"></button>`
             }
              </div>
          </div>
        </div>
